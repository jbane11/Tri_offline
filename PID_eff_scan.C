...
///Stat of the cut scan: Will Run  Calo scan first: then run Cer scan
	...
	//for(int i =0; i<num_cer; i++){
		...
		vector<Double_t> in_put1=Pid_eff_2(T,ARM.Data(),0,0,0.0,cer_thres,1.0,1);
		...
		auto Leg = new TLegend(0.9,0.9,1.0,1.0);
